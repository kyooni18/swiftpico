...
struct PicoKitConfig: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        initializeUSBInterfaceAtStart = try values.decodeIfPresent(Bool.self, forKey: .initializeUSBInterfaceAtStart)
...
public enum FlashStrategy: Equatable, Sendable {
    ...
    public static func select(requestedVolume: Bool, bootVolume: Bool, serialDeviceCount: Int, picotoolAvailable: Bool) -> Self {
