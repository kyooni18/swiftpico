...
extension SwiftPicoCommand {
    ...
    static func projectManifest(name: String, target: String, picoKitURL: String, picoKitVersion: String, picoKitPath: String?) -> String {
    ...
    static func addSwiftPMDependency(_ dependency: String, productDependency: String, to manifest: String) throws -> String {
